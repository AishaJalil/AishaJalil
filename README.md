...
- I build **production-ready applications** end-to-end (backend + frontend + database + deployment)
- I care about **clean architecture**, reusable UI components, and solid API design
- I ship using **cloud platforms** and focus on scalable backend systems
- I explore **applied AI** through academic and personal projects
